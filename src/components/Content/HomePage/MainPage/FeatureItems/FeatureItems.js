...
class FeatureItems extends React.Component {
    ...
    totalItemsCount() {
        ...
        return fetch(`http://localhost:4000/api/v1/home/${path}/count-item`, {
            method: 'GET',
            headers: {
    ...
    getListItem(page) {
        const path = this.props.match.params.cat ? this.props.match.params.cat : 'feature-items';
        return fetch(`http://localhost:4000/api/v1/home/${path}/list-items`, {
            method: 'GET',
            headers: {
                page: page,
                categoryroutine: this.props.match.params.catroutine
    ...
    getNameCategory() {
        ...
        return fetch(`http://localhost:4000/api/v1/home/${path}/name-cat`, {
            method: 'GET',
            headers: {
                categoryroutine: this.props.match.params.catroutine
            }
