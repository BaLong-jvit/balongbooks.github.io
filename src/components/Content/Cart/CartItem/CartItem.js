...
class CartItem extends React.Component {
    ...
    getBook() {
        return fetch(`http://localhost:4000/api/v1/books/get-book-by-id`, {
            method: 'GET',
    ...
    deleteItem() {
        if (localStorage.username && localStorage.password) {
            return fetch(`http://localhost:4000/api/v1/carts/delete-cart`, {
                method: 'DELETE',
    ...
    handleAddAmount() {
        ...
        if (a < 100) {
            ...
            if (localStorage.username && localStorage.password) {
                ...
                return fetch(`http://localhost:4000/api/v1/carts/update-amount`, {
                    method: 'PUT',
