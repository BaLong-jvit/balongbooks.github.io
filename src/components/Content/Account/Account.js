...
class Account extends React.Component {
    ...
    getListBoughtBooks() {
        return fetch(`http://localhost:4000/api/v1/books/get-bought-books`, {
            method: 'GET',
            headers: {
    ...
    getAccount() {
        return fetch(`http://localhost:4000/api/v1/accounts/get-account`, {
            method: 'GET',
    ...
    render() {
        ...
        console.log(this.state.accAvatar);
        return (
            <Container>
                <Row>
                    <Col xs={4}>
                        <div className='wap-img'>
                            <img src={`http://localhost:4000/image/${this.state.accAvatar.path}/${this.state.accAvatar.name}`} alt="" />
