...
class AdvertPage extends React.Component {
    ...
    getAdvert() {
        return fetch(`http://localhost:4000/api/v1/adverts/advert`, {
            method: 'GET',
            headers: {
    ...
    getBanner() {
        return fetch(`http://localhost:4000/api/v1/adverts/banner-image`, {
            method: 'GET',
            headers: {
    ...
    getListBooks() {
        return fetch(`http://localhost:4000/api/v1/adverts/list-books`, {
            method: 'GET',
            headers: {
                advertid: this.state.advert.id,
    ...
    getTotalBook() {
        return fetch(`http://localhost:4000/api/v1/adverts/get-count`, {
            method: 'GET',
            ...
            <Container>
                <div className='adv-content'>
                    <div className='adv-banner'>
                        <img src={`http://localhost:4000/image/${this.state.banner.path}/${this.state.banner.name}`} alt="" />
                    </div>
