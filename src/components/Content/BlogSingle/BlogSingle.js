...
class BlockSingle extends React.Component {
    ...
    getBlog() {
        return fetch(`http://localhost:4000/api/v1/blog/get-blog`, {
            method: 'GET',
            headers: {
    ...
    getBlogArtistName() {
        return fetch(`http://localhost:4000/api/v1/blog/blog-artist-name`, {
            method: 'GET',
    ...
    getBlogImage() {
        return fetch(`http://localhost:4000/api/v1/blog/get-blog-image`, {
            method: 'GET',
    ...
    getComments() {
        return fetch(`http://localhost:4000/api/v1/blog/get-comments`, {
            method: 'GET',
    ...
    sendComment() {
        ...
        return fetch(`http://localhost:4000/api/v1/blog/add-comment`, {
            method: 'POST',
            ...
            <Container>
                <div className='blog-single-area'>
                    <div className='blog-single'>
                        ...
                        <img src={`http://localhost:4000/image/${this.state.blogImage.path}/${this.state.blogImage.name}`} alt='' />
