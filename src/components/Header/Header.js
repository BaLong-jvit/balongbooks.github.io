...
class Header extends React.Component {
    ...
    getContact() {
        return fetch(`http://localhost:4000/api/v1/contact/get-contact-infor`).then(response => {
    ...
    getLocalShop() {
        return fetch(`http://localhost:4000/api/v1/shops/get-local-shops`).then(response => {
            return response.json();
        }).then(responseJson => {
