...
class BookRowTrash extends Component {
    ...
    componentDidMount() {
        ...
        this.getArtist();
        this.getPublisher();
        document.title = `Thùng rác | sách | Bá Long Bookstore `
    }
    ...
    getPublisher() {
        return fetch(`http://localhost:4000/api/v2/publishers/publisher`, {
            method: 'GET',
    ...
    acceptDelete(accept) {
        if (accept) {
            ...
            return fetch(`http://localhost:4000/api/v2/books/del-book`, {
                method: 'DELETE',
                headers: {
    ...
    acceptConvert(accept) {
        if (accept) {
            ...
            return fetch(`http://localhost:4000/api/v2/books/convert-book`, {
                method: 'PUT',
                headers: {
