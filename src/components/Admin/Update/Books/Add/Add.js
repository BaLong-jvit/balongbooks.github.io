...
class Add extends Component {
    ...
    getMinPub() {
        this.setState({ bookPublisher: this.state.artists[0].id });
    }
    getMaxArt() {
    ...
    uploadBook() {
        ...
        return fetch(`http://localhost:4000/api/v2/books/add-book`, {
            method: 'POST',
            ...
            return fetch(`http://localhost:4000/api/v2/book-images/add-main-image`, {
                method: 'POST',
                headers: {
                    imgname: imgname,
                    username: localStorage.adminuser,
    ...
    uploadSingleSupImage(file, id) {
        ...
        fetch(`http://localhost:4000/api/v2/book-images/add-sup-image`, {
            method: 'POST',
            headers: {
                imgname: imgname,
                username: localStorage.adminuser,
